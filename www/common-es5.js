...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  /***/
  function srcAppSharedCategoriesServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var CategoriesService = /*#__PURE__*/function () {
      ...
      _createClass(CategoriesService, [{
        ...
        key: "getAppetizers",
        value: function getAppetizers() {
          return this.http.get(this.url);
        }
      }, {
        key: "getSalads",
        value: function getSalads() {
          return this.http.get(this.url);
        }
      }, {
        key: "getSides",
        ...
        key: "getdeserts",
        value: function getdeserts() {
          return this.http.get(this.url);
        }
      }, {
        key: "getMainCourse",
        value: function getMainCourse() {
          return this.http.get(this.url);
        }
      }, {
        key: "getWordpress",
        value: function getWordpress() {
          return this.http.get(this.url);
        }
      }, {
        key: "getDrupaldata",
        value: function getDrupaldata() {
          return this.http.get(this.url);
    ...
    CategoriesService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]])], CategoriesService);
    /***/
  }
}]);
